...
func (s *fakePackingStore) UpdateItem(_ context.Context, _ string, _ string, item packing.PackingItem) (packing.PackingList, string, error) {
	...
	return s.list, s.list.Revision(), nil
}
